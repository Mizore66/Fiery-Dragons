...
class ChitPirate(Token, ABC):
    """
    Author: Yash Mahmud (32945795)

    A class used to represent a Pirate Chit Card, which is a subclass of Token.
    ...
    def __init__(self, x: int, y: int, scale: tuple, board, count: int, token_id: int):
        ...
        Constructs all the necessary attributes for the Chit Card object.
        ...
        ----------
            ...
            count : int
                the number of steps for the Chit Card (to go back)
        """
        super().__init__(x, y, scale, board, -count, AnimalType.PIRATE, token_id)
