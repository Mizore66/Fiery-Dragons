...
class ChitSalamander(Token, ABC):
    """
    Author: Yash Mahmud (32945795)

    A class used to represent a Salamander Chit Card, which is a subclass of Token.
    ...
    def __init__(self, x: int, y: int, scale: tuple, board, count: int, token_id: int):
        ...
        Constructs all the necessary attributes for the Salamander Chit Card object.
        ...
        """
        super().__init__(x, y, scale, board, count, AnimalType.SALAMANDER, token_id)
