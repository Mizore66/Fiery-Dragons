...
class ChitEgg(Token, ABC):
    """
    Author: Yash Mahmud (32945795)

    A class used to represent an Egg Chit Card, which is a subclass of Token.
    ...
    def __init__(self, x: int, y: int, scale: tuple, board, count: int, token_id: int):
        ...
        Constructs all the necessary attributes for the ChitEgg object.
        ...
        """
        super().__init__(x, y, scale, board, count, AnimalType.EGG, token_id)
